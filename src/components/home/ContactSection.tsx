            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Highland City, Tech Valley, CA 91234
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-highlands-light p-3 rounded-full text-gray-600 hover:text-highlands-primary transition">
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-highlands-primary hover:bg-highlands-dark"
