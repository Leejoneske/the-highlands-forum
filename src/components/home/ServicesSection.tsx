...
const ServicesSection = () => {
  return (
    <section className="py-20 bg-rapidway-light" id="services">
      <div className="section-container">
        <div className="text-center mb-16 animate-on-scroll">
          <h2 className="text-3xl font-bold mb-4">My Services</h2>
          <div className="w-20 h-1 bg-rapidway-dark mx-auto mb-6"></div>
        ...
        <div className="text-center mt-14 animate-on-scroll">
          <Link to="/services">
            <Button className="bg-rapidway-dark hover:bg-opacity-90 text-white font-medium">
              View All Services
