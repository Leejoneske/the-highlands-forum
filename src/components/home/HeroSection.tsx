...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-b from-blue-50 to-white pt-12 md:pt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-on-scroll">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/projects">
                <Button variant="outline" size="lg" className="border-highlands-primary text-highlands-primary hover:bg-highlands-light">
                  View Projects
                </Button>
              </Link>
            </div>
